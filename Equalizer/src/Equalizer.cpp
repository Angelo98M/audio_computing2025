...
Equalizer_VC::EqualizerAudioProcessor()
...
void Equalizer_VC::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void Equalizer_VC::updateFilters()
{
...
void Equalizer_VC::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer&)
{
